...
set "AMENT_ENVIRONMENT_HOOKS[draft]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[draft] "%AMENT_CURRENT_PREFIX%\share\draft\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[draft] "%AMENT_CURRENT_PREFIX%\share\draft\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[draft]:;=";"%") do (
    call:call_file %%f
  )

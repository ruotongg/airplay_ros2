...
static const _Pos_type_support_symbol_names_t _Pos_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ap_interfaces, msg, Pos)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ap_interfaces, msg, Pos)),
  }
};
...
{
  return &::ap_interfaces::msg::rosidl_typesupport_cpp::Pos_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ap_interfaces, msg, Pos)() {
  return get_message_type_support_handle<ap_interfaces::msg::Pos>();
}

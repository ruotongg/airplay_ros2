function slBusOut = Int32MultiArray(msgIn, slBusOut, varargin)
%#codegen
%   Copyright 2021 The MathWorks, Inc.
    currentlength = length(slBusOut.layout);
    for iter=1:currentlength
        slBusOut.layout(iter) = bus_conv_fcns.ros2.msgToBus.example_interfaces.MultiArrayLayout(msgIn.layout(iter),slBusOut(1).layout(iter),varargin{:});
    end
    slBusOut.layout = bus_conv_fcns.ros2.msgToBus.example_interfaces.MultiArrayLayout(msgIn.layout,slBusOut(1).layout,varargin{:});
    ...
    slBusOut.data = int32(msgIn.data(1:slBusOut.data_SL_Info.CurrentLength));

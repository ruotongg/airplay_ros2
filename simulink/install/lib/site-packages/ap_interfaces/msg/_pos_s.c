...
bool ap_interfaces__msg__pos__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // x
    ...
    int16_t * dest = ros_message->x.data;
  ...
  {  // y
    ...
    int16_t * dest = ros_message->y.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
  ...
  {  // player_id
    ...
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'player_id'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    int8_t * dest = ros_message->player_id.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
  ...
  {  // tag_id
    ...
    rosidl_runtime_c__String * dest = ros_message->tag_id.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
  ...
  {  // size
    ...
    int8_t * dest = ros_message->size.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
...
PyObject * ap_interfaces__msg__pos__convert_to_py(void * raw_ros_message)
{
  ...
  {  // x
    ...
    if (ros_message->x.size > 0) {
      ...
      int16_t * src = &(ros_message->x.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->x.size * sizeof(int16_t));
      assert(data != NULL);
  ...
  {  // y
    ...
    if (ros_message->y.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int16_t * src = &(ros_message->y.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->y.size * sizeof(int16_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // player_id
    ...
    if (ros_message->player_id.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int8_t * src = &(ros_message->player_id.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->player_id.size * sizeof(int8_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // tag_id
    ...
    rosidl_runtime_c__String * src = ros_message->tag_id.data;
  ...
  {  // size
    ...
    if (ros_message->size.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int8_t * src = &(ros_message->size.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->size.size * sizeof(int8_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
